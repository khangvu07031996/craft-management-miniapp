...
<body>
  ...
  <div class="signature">
    ...
    try {
      ...
      const periodSlug = salary.dateFrom && salary.dateTo
        ? `${salary.dateFrom}_${salary.dateTo}`.replace(/-/g, '')
        : `${salary.month}_${salary.year}`;
      const filename = `PhieuLuong_${sanitizedName}_${periodSlug}.pdf`;
